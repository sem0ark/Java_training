...
public class LevelScene extends Scene {
    ...
    public void init() {
        ...
        player = new GameObject("Some game object", new Transform(new Vector2(300.0f,300.0f)), 0);
    ...
    public void initAssetPool() {
        ...
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/spritesheet.png",
                42, 42, 2, 6, 12);
        AssetPool.getSprite("GeometryDash_gameswithgabe/assets/player/spaceship.png");
    }
        ...
        for (GameObject g: gameObjects) {
            ...
            if (b != null) {
                if (Bounds.checkCollision(playerBounds, b)) {
                    Bounds.resolveCollicsion(b, player);
                }
            }
        }
    }
