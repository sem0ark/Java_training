...
import com.Components.CameraControls;
import com.Components.Grid;
...
public class LevelEditorScene extends Scene {
    ...
    public void init() {
        ...
        mouseCursor.addComponent(new LevelEditorConterols(Constants.TILE_WIDTH, Constants.TILE_HEIGHT));

        player = new GameObject("Player", new Transform(new Vector2(300.0f,300.0f)), 0);

        SpriteSheet layerOne = AssetPool.getSpriteSheet(
                "GeometryDash_gameswithgabe/assets/player/layerOne.png");
        SpriteSheet layerTwo = AssetPool.getSpriteSheet(
                "GeometryDash_gameswithgabe/assets/player/layerTwo.png");
        SpriteSheet layerThree = AssetPool.getSpriteSheet(
                "GeometryDash_gameswithgabe/assets/player/layerThree.png");
    ...
    public void initAssetPool() {
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/player/layerOne.png",
                42, 42, 2, 13, 13*5);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/player/layerTwo.png",
                42, 42, 2, 13, 13*5);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/player/layerThree.png",
                42, 42, 2, 13, 13*5);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/spritesheet.png",
                42, 42, 2, 6, 12);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/ui/buttonSprites.png",
                60, 60, 2, 2, 2);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/ui/tabs.png",
                Constants.TAB_WIDTH, Constants.TAB_HEIGHT, 2, 6, 6);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/spikes.png",
                42, 42, 2, 6, 4);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/bigSprites.png",
                84, 84, 2, 2, 2);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/smallBlocks.png",
                42, 42, 2, 6, 1);
        AssetPool.addSpriteSheet("GeometryDash_gameswithgabe/assets/portal.png",
                44, 85, 2, 2, 2);
    }
    ...
    public void initBackgrounds() {
        ...
        for (int i=0; i<numBackgrounds; i++) {
            ParallaxBackground bg = new ParallaxBackground("GeometryDash_gameswithgabe/assets/backgrounds/bg01.png",
            ...
            ParallaxBackground groundBg = new ParallaxBackground("GeometryDash_gameswithgabe/assets/grounds/ground01.png",
    ...
    public void update(double dt) {
        ...
        if (objsToRemove.size() > 0) {
            for (GameObject go : objsToRemove) {
                ...
                renderer.gameObjects.remove(go);
            }
            objsToRemove.clear();
        }
    }
    ...
    private void export(String fileName) {
        try {
            FileOutputStream fos = new FileOutputStream("GeometryDash_gameswithgabe/levels/" + fileName + ".zip");
