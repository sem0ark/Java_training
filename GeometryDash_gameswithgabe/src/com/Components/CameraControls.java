...
public class CameraControls extends Component {
    ...
    public void update(double dt) {
        if (Window.getWindow().mouseListener.mousePressed &&
            ...
            float dx = (Window.getWindow().mouseListener.x +
                    Window.getWindow().mouseListener.dx - prevMx);
            float dy = (Window.getWindow().mouseListener.y +
                    Window.getWindow().mouseListener.dy - prevMy);
