...
public class Constants {
    ...
    public static final String SCREEN_TITLE = "Geometry Dash (kind of)";
    ...
    public static final float GRAVITY = 2850.0f;
    public static final float TERMINAL_VELOCITY = 1900.0f;

    public static final int TILE_HEIGHT = 42;
    public static final int TILE_WIDTH = 42;

    public static final int BUTTON_OFFSET_X = 400;
    public static final int BUTTON_OFFSET_Y = 580;

    public static final int BUTTON_IMAGE_OFFSET_X = 10;
    public static final int BUTTON_IMAGE_OFFSET_Y = 10;
    ...
    public static final Color BG_COLOR =
            new Color(15.0f / 255.0f, 98.0f / 255.0f ,212.0f / 255.0f, 1.0f);
    public static final Color GROUND_COLOR =
            new Color(28.0f / 255.0f, 70.0f / 255.0f ,148.0f / 255.0f, 1.0f);
